        ...
        <div id="wrapper">
            ...
            <ul id="index_cards" style="position:relative;">
                <li id="card-1" style="height: 5em">
                    <h3>Pulgarcita</h3>
                    <a style="" href="http://www.milcuentos.com/pulgarcita/slide1.html" target="_blank"><img src="http://www.escritoresarg.com.ar/fotos%20nov/pulgarcita.jpg"
                         height="130" width="130" alt="Pulgarcita" />
                    </a>
                </li>
                 <li id="card-2" style="height:5em">
                    <h3>Quiero ser distinta</h3>
                    <a style="" href="http://www.milcuentos.com/distinta/slide1.html" target="_blank"><img src="../images/distinta.png"
                         height="130" width="130" alt="Pulgarcita" />
                    </a>
                </li>
                 <li id="card-3" style="height:5em">
                    <h3>Pedro y el Lobo</h3>
                    <a style="" href="http://www.milcuentos.com/pedro/slide1.html" target="_blank"><img src="http://www.cuentos-infantiles.org/wp-content/uploads/2009/10/pedro-y-el-lobo.jpg"
                         height="130" width="130" alt="Pulgarcita" />
                    </a>
                </li>
                 <li id="card-4" style="height:5em">
                    <h3>El Pez Gato</h3>
                    <a style="" href="http://www.milcuentos.com/gatopez/slide1.html" target="_blank"><img src="../images/gatopez.png"
                         height="130" width="130" alt="Pulgarcita" />
                    </a>
                </li>
            </ul>
